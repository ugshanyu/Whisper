...
def main():
    ...
    common_voice_train = common_voice['train'].map(prepare_dataset, remove_columns=common_voice['train'].column_names)
    common_voice_test = common_voice['test'].map(prepare_dataset, remove_columns=common_voice['test'].column_names)
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir="./whisper-large-hi",  # change to a repo name of your choice
